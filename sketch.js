...
function setup() {
  createCanvas(windowWidth, windowHeight);//500, 800
  frameRate(80);
  ...
  ground =new Ground(windowWidth / 2,height-10,windowWidth,20);//250, height-10, width, 20
...
function draw() 
{
  ...
  if(collide(fruit,bunny,105)==true)//80
  {
   remove_rope();
